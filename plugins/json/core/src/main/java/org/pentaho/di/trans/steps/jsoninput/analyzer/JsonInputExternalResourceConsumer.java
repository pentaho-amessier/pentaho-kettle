...
public class JsonInputExternalResourceConsumer
  ...
  @Override
  public boolean isDataDriven( JsonInputMeta meta ) {
    return meta.isAcceptingFilenames();
  }

  @Override
  public Collection<IExternalResourceInfo> getResourcesFromMeta( JsonInputMeta meta, IAnalysisContext context ) {
  ...
  public Collection<IExternalResourceInfo> getResourcesFromRow(
    JsonInput step, RowMetaInterface rowMeta, Object[] row ) {
