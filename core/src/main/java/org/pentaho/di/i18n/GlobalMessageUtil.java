...
public class GlobalMessageUtil {
  ...
  private static GlobalMessageUtil instance = null;

  private GlobalMessageUtil() {
  }

  public static GlobalMessageUtil getInstance() {
    if ( instance == null ) {
      synchronized ( GlobalMessageUtil.class ) {
        if ( instance == null ) {
          instance = new GlobalMessageUtil();
        }
      }
    }
    return instance;
  ...
  private Set<Locale> activeLocales = Collections.synchronizedSet( new LinkedHashSet<Locale>() );
  ...
  public String getString( ResourceBundle bundle, String key ) throws MissingResourceException {
    return MessageFormat.format( bundle.getString( key ), new Object[] {} );
  }

  public String getErrorString( ResourceBundle bundle, String key ) {
    return formatErrorMessage( key, getString( bundle, key ) );
  }

  public String getString( ResourceBundle bundle, String key, String param1 ) {
    try {
      Object[] args = { param1 };
  ...
  public String getErrorString( ResourceBundle bundle, String key, String param1 ) {
    return formatErrorMessage( key, getString( bundle, key, param1 ) );
  }

  public String getString( ResourceBundle bundle, String key, String param1, String param2 ) {
    try {
  ...
  public String getErrorString( ResourceBundle bundle, String key, String param1, String param2 ) {
    return formatErrorMessage( key, getString( bundle, key, param1, param2 ) );
  }

  public String getString( ResourceBundle bundle, String key, String param1, String param2, String param3 ) {
    try {
  ...
  @VisibleForTesting
  Map<Locale, String> calculateString( String packageName, Set<Locale> locales, String key, Object[] parameters,
  ...
  private String decorateMissingKey( final String key ) {
   ...
   */
  private String getBestMatch( final String key, final Set<Locale> locales, final Map<Locale, String>
    potentialMatches ) {
  ...
  @VisibleForTesting
  String calculateString( String packageName, Locale locale, String key, Object[] parameters,
                          Class<?> resourceClass, final String bundleName ) {
   ...
   */
  public ResourceBundle getBundle( String packagePath, Class<?> resourceClass ) {
  ...
  public ResourceBundle getBundle( Locale locale, String packagePath, Class<?> resourceClass ) {
    return getBundle( locale, packagePath, resourceClass, true );
  }



  public ResourceBundle getBundle( final Locale locale, final String packagePath, final Class<?> resourceClass,
        ...
        bundle = ResourceBundle.getBundle( packagePath, locale, resourceClass.getClassLoader(),
          new ResourceBundle.Control() {
            ...
            public ResourceBundle newBundle ( final String baseName, final Locale locale, final String format,
              ...
              ResourceBundle bundle = locales.get( bundleName );
   ...
   */
  protected String getLocaleString( Locale locale ) {
   ...
   */
  protected String buildHashKey( Locale locale, String packagePath ) {
   ...
   */
  protected boolean isMissingKey( final String string ) {
